...
private const val OR_TEXT = "یا استفاده از"

private const val FORGOT_CARD = "کد فراموشی"

private const val USER_PASSWORD = "کد ملی و رمز"
...
object Home : VBox(12.0), VisibleAware {
    ...
    init {
        ...
        forgotBtn.onAction = EventHandler { SceneController.showForgetCardView() }
        children += forgotBtn

        val passwordBtn = Button(USER_PASSWORD)
        passwordBtn.onAction = EventHandler { SceneController.showUserPassView() }
        children += passwordBtn
